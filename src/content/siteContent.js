...
const projects = [
	...
	{ id: '007', title: 'FADE', category: 'gameDev, threed', seed: 'fade', projectUrl: '#project-007' },
	{ id: '008', title: 'MICROSOFT HUDDLE', category: 'gameDev, web, threed', seed: 'microsoft-huddle', projectUrl: '#project-008' },
]
...
const projectMontageLayout = {
	...
	'004': [
		{ src: '/trabajos/Omega-traicion 05.png', x: 33, y: 34, w: 22, z: 4 },
		{ src: '/trabajos/Omega-traicion 03.png', x: 26, y: 67, w: 32, z: 2 },
		{ src: '/trabajos/Omega-traicion 01.png', x: 66, y: 41, w: 10, z: 5 },
		{ src: '/trabajos/Omega-traicion 04.png', x: 58, y: 61, w: 18, z: 3 },
		{ src: '/trabajos/Omega-traicion 02.png', x: 84, y: 40, w: 22, z: 1 },
	],
	'005': [
		{ src: '/trabajos/mindscape05.png', x: 42, y: 40, w: 36, z: 1 },
		{ src: '/trabajos/mindscape04.png', x: 23, y: 58, w: 13, z: 5 },
		{ src: '/trabajos/mindscape02.png', x: 74, y: 38, w: 9, z: 4 },
		{ src: '/trabajos/mindscape03.png', x: 85, y: 56, w: 14, z: 3 },
		{ src: '/trabajos/mindscape01.png', x: 59, y: 63, w: 18, z: 6 },
	],
	'006': [
...
const projectDetailImages = {
	'001': ['/trabajos/transpapelades-1.png', '/trabajos/transpapelades-1.png', '/trabajos/transpapelades-2.png', '/trabajos/transpapelades-4.png'],
	'002': ['/trabajos/Echar-raices 02.png', '/trabajos/Echar-raices 04.png', '/trabajos/Echar-raices 01.png', '/trabajos/Echar-raices 03.png'],
	...
	'007': ['/trabajos/Fade03.png', '/trabajos/Fade04.png', '/trabajos/Fade01.png', '/trabajos/Fade02.png'],
	'008': ['/trabajos/Huddle 03.png', '/trabajos/Huddle 01.png', '/trabajos/Huddle 04.png', '/trabajos/Huddle 02.png'],
}
...
const gridProjectsByLanguage = {
	en: [
		{ id: 'g-01', category: 'web', title: 'TRANSPAPELADES', year: '2024', disciplines: 'WEB', images: ['/trabajos/transpapelades-1.png'] },
		{ id: 'g-02', category: 'web, gameDev', title: 'ECHAR RAICES', year: '2024', disciplines: 'WEB / GAME-DEV', images: ['/trabajos/Echar-raices 03.png', '/trabajos/Echar-raices 05.png', '/trabajos/Echar-raices 01.png'] },
		{ id: 'g-03', category: 'uxui', title: 'ENTRELINEAS', year: '2024', disciplines: 'UX/UI', images: ['/trabajos/Entrelineas 01.png', '/trabajos/Entrelineas 04.png'] },
		{ id: 'g-04', category: 'web, gameDev, graphic', title: 'OMEGA TRAICION', year: '2024', disciplines: 'WEB / GAME-DEV / GRAPHIC', images: ['/trabajos/Omega-traicion 01.png', '/trabajos/Omega-traicion 05.png'] },
		{ id: 'g-05', category: 'uxui', title: 'MINDSCAPE', year: '2024', disciplines: 'UX/UI', images: ['/trabajos/mindscape01.png'] },
		{ id: 'g-06', category: 'web', title: 'ERMES OLEA PORFOLIO', year: '2024', disciplines: 'WEB', images: ['/trabajos/E-porfolio-1.png',  '/trabajos/E-porfolio-3.png', '/trabajos/E-porfolio.png'] },
		{ id: 'g-07', category: 'gameDev, threed', title: 'FADE', year: '2024', disciplines: 'GAME-DEV / 3D', images: ['/trabajos/Fade04.png', '/trabajos/Fade02.png'] },
		{ id: 'g-08', category: 'gameDev, web, threed', title: 'MICROSOFT HUDDLE', year: '2024', disciplines: 'GAME-DEV / WEB / 3D', images: ['/trabajos/Huddle 01.png', '/trabajos/Huddle 03.png', '/trabajos/Huddle 02.png'] },
	],
	es: [
		{ id: 'g-01', category: 'web', title: 'TRANSPAPELADES', year: '2024', disciplines: 'WEB', images: ['/trabajos/transpapelades-1.png'] },
		{ id: 'g-02', category: 'web, gameDev', title: 'ECHAR RAICES', year: '2024', disciplines: 'WEB / GAME-DEV', images: ['/trabajos/Echar-raices 01.png', '/trabajos/Echar-raices 02.png', '/trabajos/Echar-raices 03.png'] },
		{ id: 'g-03', category: 'uxui', title: 'ENTRELINEAS', year: '2024', disciplines: 'UX/UI', images: ['/trabajos/Entrelineas 01.png', '/trabajos/Entrelineas 02.png'] },
		{ id: 'g-04', category: 'web, gameDev, graphic', title: 'OMEGA TRAICION', year: '2024', disciplines: 'WEB / GAME-DEV / GRÁFICO', images: ['/trabajos/Omega-traicion 01.png', '/trabajos/Omega-traicion 02.png', '/trabajos/Omega-traicion 03.png'] },
		{ id: 'g-05', category: 'uxui', title: 'MINDSCAPE', year: '2024', disciplines: 'UX/UI', images: ['/trabajos/mindscape01.png'] },
		{ id: 'g-06', category: 'web', title: 'ERMES OLEA PORFOLIO', year: '2024', disciplines: 'WEB', images: ['/trabajos/E-porfolio-1.png', '/trabajos/E-porfolio-2.png', '/trabajos/E-porfolio-3.png'] },
		{ id: 'g-07', category: 'gameDev, threed', title: 'FADE', year: '2024', disciplines: 'GAME-DEV / 3D', images: ['/trabajos/Fade01.png', '/trabajos/Fade02.png'] },
		{ id: 'g-08', category: 'gameDev, web, threed', title: 'MICROSOFT HUDDLE', year: '2024', disciplines: 'GAME-DEV / WEB / 3D', images: ['/trabajos/Huddle 01.png', '/trabajos/Huddle 02.png'] },
	]
}
